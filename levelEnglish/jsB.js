...
var eng=["Addiction","Amateur","Apron","Bodyguard","Canteen",
"Collapse","Dedication","Descend","Elaborate","Evidence","Gluttony",
"Honesty","Investigate","Kindness","Mirror","Naughty","Petrol"];
var rus=["Дополнение","Любитель","Фартук","Телохранитель", "Столовая",
"Разрушаться","Верность","Спускаться","Разрабатывать","Доказательство",
 "Обжорство","Честность","Исследовать","Доброта","Зеркало","Непослушный","Бензин"];
let countTrue=0;
let countFalse=0;
var i;
var iteration=1;
